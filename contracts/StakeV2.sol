...
contract StakeV2Contract {
    // Define APR values scaled by 10^18 to handle 18 decimals
     uint256[6][6] APR = [
        [uint256(2500000000000000), uint256(7500000000000000), uint256(15000000000000000), uint256(30000000000000000), uint256(45000000000000000), uint256(60000000000000000)],
        [uint256(2500000000000000), uint256(15000000000000000), uint256(30000000000000000), uint256(60000000000000000), uint256(90000000000000000), uint256(120000000000000000)],
        [uint256(2500000000000000), uint256(15000000000000000), uint256(45000000000000000), uint256(90000000000000000), uint256(135000000000000000), uint256(180000000000000000)],
        [uint256(2500000000000000), uint256(15000000000000000), uint256(45000000000000000), uint256(120000000000000000), uint256(180000000000000000), uint256(240000000000000000)],
        [uint256(2500000000000000), uint256(15000000000000000), uint256(45000000000000000), uint256(120000000000000000), uint256(225000000000000000), uint256(300000000000000000)],
    ...
    function stake(uint256 amount, uint256 stakeMonth) public {
        ...
        emit Staked(msg.sender, amount, stakeMonth, apr);
    }
